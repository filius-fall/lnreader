...
export interface StringMap {
  ...
  'ai.settings.title': 'string';
  'ai.settings.backend': 'string';
  'ai.settings.baseUrl': 'string';
  'ai.settings.apiKey': 'string';
  'ai.settings.timeout': 'string';
  'ai.settings.models': 'string';
  'ai.settings.embeddingModel': 'string';
  'ai.settings.rerankerModel': 'string';
  'ai.settings.answerModel': 'string';
  'ai.settings.modelInfo': 'string';
  'ai.settings.enable': 'string';
  'ai.settings.disable': 'string';
  'ai.settings.enabledToast': 'string';
  'ai.settings.disabledToast': 'string';
  'ai.settings.footer': 'string';
  'ai.reader.askTitle': 'string';
  'ai.reader.ask': 'string';
  'ai.reader.answer': 'string';
  'ai.reader.question': 'string';
  'ai.reader.selectedText': 'string';
  'ai.reader.citations': 'string';
  'ai.reader.noSpoilers': 'string';
  'ai.novel.enable': 'string';
  'ai.novel.reindex': 'string';
  'ai.indexing.started': 'string';
  'ai.indexing.downloadingChapter': 'string';
  'ai.indexing.processingChapter': 'string';
  'ai.indexing.ready': 'string';
  'ai.errors.configureBackend': 'string';
  'ai.errors.enableFeature': 'string';
  'ai.errors.novelNotFound': 'string';
  'ai.errors.notReady': 'string';
  'ai.errors.noContext': 'string';
  ...
  'notifications.INDEX_NOVEL_AI': 'string';
}
